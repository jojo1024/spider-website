                    ...
                    <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div className="room-item shadow rounded overflow-hidden">
                            <div className="position-relative">
                                <img className="img-fluid" src="img/orange-money.jpg" alt="" />
                            </div>
                        ...
                        <div className="room-item shadow rounded overflow-hidden">
                            ...
                            <div className="p-4 mt-2">
                                ...
                                <div>
                                    ...
                                    <p>
                                        NB :  Si vous êtes un nouvel entrant et que vous n'êtes pas reconnu 
                                        dans le fichier 2019-2020, prenez attache avec votre établissement 
                                        pour régulariser votre situation auprès de la DSPS avant d'effectuer votre inscription. 
                                        En résumé : Votre préinscription 2020-2021 dépend de deux éléments : 
                                        Votre présence dans le fichier national (matricule valide) Votre inscription et actualisation
                                         dans le fichier 2019-2020 (pour les anciens) ou Votre Décision d'Affectation ou 
                                         d'Orientation 2020-2021 (pour les nouveaux)
                                    </p>
                                </div>
                            </div>
                        </div>

                        ...
                        <div className='p-4 shadow'>
                            ...
                            {allActualite
                                ...
                                .map((item: IActualite, index: number) => (
                                    <div>
                                        <div key={index} className={`d-flex align-items-center mb-3 `} style={{ cursor: 'pointer' }} onClick={() => setSelectedItem(item.idActualite)}>
                                            <img
                                        ...
                                        <hr className="bg-green mx-auto mt-0" style={{ width: "310px" }} />
                                    </div>
                                ))}
                        </div>
                    </div>

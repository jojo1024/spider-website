...
$ git init
$ git remote add origin https://gitlab.com/konanmichelkomoe/spider-caisse.git
$ git status
$ git add .
$ git commit -m "first depot"

$ git config --global user.email "joelithondjabo16@gmail.com"
$ git config --global user.name "Ndjabo"

$ git checkout -b ndjabo-client

//-f pour supprimer les fichiers qui y sonr deja , c est quand ce que on veut pusher ne correspondent pas
$ git push -u origin ndjabo-client
//sinon
$ git push -u origin ndjabo-client
